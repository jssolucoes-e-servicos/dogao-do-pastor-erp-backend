...
import { IMPCustomer } from './mp-customer.interface';
import { IMPOrder } from './mp-order.interface';
import { IMPPayment } from './mp-payment.interface';
import { IMPPix } from './mp-pix.interface';
import { IMPWebhook } from './mp-webhook.interface';
import { IPagination } from './pagination.type';
import { IPaymentRequest, IPaymentResponse } from './payment.interface';
import { IPhoneValidator } from './phone-validator.inteface';
