...
async function bootstrap() {
  ...
  const frontendUrl = configService.get('NEXTJS_FRONTEND_URL')!;
  app.enableCors({
    origin: [frontendUrl, 'http://localhost:3000'], // Permitir o frontend e o ambiente de desenvolvimento local
